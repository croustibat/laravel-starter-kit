...
<div class="relative inline-flex" x-data="{ open: false }">
    <button
        ...
        :aria-expanded="open"                        
    >
        <img class="w-8 h-8 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&color=7F9CF5&background=EBF4FF" width="32" height="32" alt="{{ Auth::user()->name }}" />
    ...
    >
        ...
        <ul>
            <li>
                <a class="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" href="{{ route('profile') }}" @click="open = false" @focus="open = true" @focusout="open = false">Settings</a>
            </li>
            <li>
