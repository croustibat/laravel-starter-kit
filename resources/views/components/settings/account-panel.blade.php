    ...
    <div class="p-6 space-y-6">
        ...
        <section>
            <div class="flex items-center">
                ...
                <button class="btn-sm bg-violet-500 hover:bg-violet-600 text-white">Change</button>
            </div>
        </section>
        <!-- Business Profile -->
        <section>
            ...
            <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                ...
                <div class="sm:w-1/3">
                    ...
                    <input id="business-id" class="form-input w-full" type="text" value="Kz4FSEjP" />
                </div>
                <div class="sm:w-1/3">
        ...
        <section>
            ...
            <div class="flex flex-wrap mt-5">
                <div class="mr-2">
                    ...
                    <input id="email" class="form-input" type="email" value="{{ auth()->user()->email ?? 'admin@acmeinc.com' }}" />
                </div>
                <button class="btn bg-violet-500 hover:bg-violet-600 text-white">Change</button>
            </div>
        </section>
        <!-- Password -->
        <section>
            ...
            <div class="mt-5">
                <button class="btn bg-violet-500 hover:bg-violet-600 text-white">Set New Password</button>
            </div>
        </section>
        <!-- Smart Sync -->
        <section>
